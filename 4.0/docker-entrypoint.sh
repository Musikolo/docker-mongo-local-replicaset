...
mongod --port 27003 --smallfiles --dbpath /data/db3 --auth --replSet $REPLICA_SET_NAME --keyFile /var/mongo_keyfile --bind_ip_all &
DB3_PID=$!
mongod --port 27002 --smallfiles --dbpath /data/db2 --auth --replSet $REPLICA_SET_NAME --keyFile /var/mongo_keyfile --bind_ip_all &
DB2_PID=$!
mongod --port 27001 --smallfiles --dbpath /data/db1 --auth --replSet $REPLICA_SET_NAME --keyFile /var/mongo_keyfile --bind_ip_all &
DB1_PID=$!
